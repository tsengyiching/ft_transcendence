   ...
   //         {/*<div className='waiting-text'>looking for a partner...</div>*/}
	...
	return (
        <div className="row align-self-center">
            ...
            {toggleGame ? <Image src='https://media4.giphy.com/media/gx54W1mSpeYMg/giphy.gif' fluid/> : <Image src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4zqAcI7RlbhpEpf_gqQpC3krnJeYXifFIwg&usqp=CAU' fluid />}
            <div className="col"></div>
		</div>
	);
}
